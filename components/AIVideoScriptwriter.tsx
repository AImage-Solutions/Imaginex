...
const guideSteps = [
    {
        ...
        description: "Provide an image of your product or scene for context."
    },
    {
        ...
        description: "Describe the video's topic. The AI will use the image and topic to write the script."
    },
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>,
        title: "Generate Script",
        description: "Let the AI write a complete script with a hook, scenes, and a call to action."
    },
];
...
const AIVideoScriptwriter: React.FC = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const generatedScript = await generateAdScript(topic, 'Promotional', imageFile ?? undefined);
    ...
    return (
        <div className="max-w-7xl mx-auto">
            <ToolHeader toolKey={ToolKey.AIVideoScriptwriter} />
                        ...
                        <div className="md:sticky md:top-24 h-fit">
                            <div className="glass-card rounded-lg p-6 space-y-4">
                                ...
                                <div className="relative">
                                    <h3 className="text-lg font-medium text-slate-700 mb-2">Topic</h3>
                                    <textarea
                                        value={topic}
                                        onChange={(e) => setTopic(e.target.value)}
                                        placeholder="e.g., a 30-second ad for a new tech gadget"
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    title="Generate a video script from your topic"
                        ...
                        <div>
                            {loading ? (
                                <ProcessingView
                                    ...
                                    messages={[ "Brainstorming a hook...", "Structuring main points...", "Writing scene descriptions...", "Crafting a call to action..." ]}
...
export default AIVideoScriptwriter;