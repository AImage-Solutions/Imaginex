...
const guideSteps = [
    {
        ...
        description: "Start with a static image to inspire your video scene."
    },
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>,
        title: "Generate Video Prompt",
        description: "The AI will imagine what happens before, during, and after the image, creating a video prompt."
    },
    {
        ...
        description: "Copy the cinematic prompt to an AI video generator to see the action unfold."
    },
];
...
const ImageToVideoPrompt: React.FC = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const generatedPrompt = await generateVideoPromptFromImage(imageFile);
    ...
    return (
        <div className="max-w-7xl mx-auto">
            <ToolHeader toolKey={ToolKey.ImageToVideoPrompt} />
                ...
                <div className="lg:col-span-8 xl:col-span-9">
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="md:sticky md:top-24 h-fit">
                            <div className="glass-card p-6 rounded-lg space-y-4">
                                ...
                                <button
                                    ...
                                    title="Generate a cinematic video prompt based on your image"
                        ...
                        <div>
                            {loading ? (
                                <ProcessingView
                                    title="Imagining a Video..."
                                    messages={[
                                        "Analyzing the static image...",
                                        "Brainstorming motion and narrative...",
                                        "Adding cinematic details...",
                                        "Crafting a dynamic video prompt..."
                                    ]}
                                    previewUrl={preview!}
                                />
                            ) : (
