...
const guideSteps = [
    ...
    },
    {
        ...
        description: "Click the 'Generate Prompt' button to let the AI analyze your image."
    },
    {
        ...
        title: "Copy & Use",
        description: "Your creative prompt will appear. Copy it to use in any AI image generator."
    },
];
                        ...
                        <div className="md:sticky md:top-24 h-fit">
                            <div className="glass-card p-6 rounded-lg space-y-4">
                                ...
                                <button
                                    ...
                                    title="Generate a text prompt from your image"
                            ...
                            {loading ? (
                                <ProcessingView
                                    ...
                                    messages={[
                                        ...
                                        "Crafting a creative prompt..."
                                    ]}
                                    previewUrl={preview!}
                                />
                            ) : (
                                prompt && <ResultCard title="Generated Prompt" content={prompt} />
                            )}
                        </div>
                    </div>
                </div>
