...
const guideSteps = [
    {
        ...
        description: "Select any image file you want the AI to describe."
    },
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>,
        title: "Generate Description",
        description: "Click the button to let the AI analyze the image and write a detailed description."
    },
    {
        ...
        description: "The AI's narrative description will appear, detailing the mood, story, and setting."
    },
];

const AIDescribeImage: React.FC = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const generatedDescription = await describeImage(imageFile);
    ...
    return (
        <div className="max-w-7xl mx-auto">
            <ToolHeader toolKey={ToolKey.AIDescribeImage} />
                ...
                <div className="lg:col-span-8 xl:col-span-9">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="md:sticky md:top-24 h-fit">
                            <div className="glass-card p-6 rounded-lg space-y-4">
                                ...
                                <button
                                    ...
                                    title="Generate a narrative description for your image"
                        ...
                        <div>
                            {loading ? (
                                <ProcessingView
                                    title="Describing Your Image..."
                                    messages={[
                                        "Analyzing the scene's mood and setting...",
                                        "Identifying subjects and their interactions...",
                                        "Interpreting the potential story...",
                                        "Composing a narrative description..."
                                    ]}
                                    previewUrl={preview!}
                                />
                            ) : (
                                description && <ResultCard title="AI Description" content={description} />
                            )}
                        </div>
                    </div>
                </div>
...
export default AIDescribeImage;