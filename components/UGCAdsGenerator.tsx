...
const guideSteps = [
    ...
    },
    {
        ...
        description: "Describe the product or topic for your User-Generated Content style ad."
    },
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>,
        title: "Generate UGC Script",
        description: "The AI will write a script that feels authentic and user-driven."
    },
];
...
const UGCAdsGenerator: React.FC = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const generatedScript = await generateAdScript(topic, 'UGC', imageFile ?? undefined);
    ...
    return (
        <div className="max-w-7xl mx-auto">
            <ToolHeader toolKey={ToolKey.UGCAdsGenerator} />
                ...
                <div className="lg:col-span-8 xl:col-span-9">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="md:sticky md:top-24 h-fit">
                            <div className="glass-card rounded-lg p-6 space-y-4">
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    title="Generate a UGC ad script from your topic"
                        ...
                        <div>
                            {loading ? (
                                <ProcessingView
                                    title="Writing Your UGC Script..."
                                    messages={[ "Finding an authentic angle...", "Crafting a relatable hook...", "Writing conversational scenes...", "Adding a friendly call to action..." ]}
...
export default UGCAdsGenerator;