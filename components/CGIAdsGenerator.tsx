...
const guideSteps = [
    {
        ...
        description: "Provide a product image to be featured in the CGI ad concept."
    },
    {
        ...
        description: "Write a high-level concept for your ad (e.g., 'a sports car driving on Mars')."
    },
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>,
        title: "Generate CGI Script",
        description: "The AI will flesh out your idea into a script with stunning visual descriptions."
    },
];
...
const CGIAdsGenerator: React.FC = () => {
    ...
    const handleSubmit = async () => {
        if (!topic.trim()) {
            setError('Please enter a concept for your script.');
            return;
        }
        ...
        try {
            const generatedScript = await generateAdScript(topic, 'CGI', imageFile ?? undefined);
    ...
    return (
        <div className="max-w-7xl mx-auto">
            <ToolHeader toolKey={ToolKey.CGIAdsGenerator} />
                ...
                <div className="lg:col-span-8 xl:col-span-9">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="md:sticky md:top-24 h-fit">
                            <div className="glass-card rounded-lg p-6 space-y-4">
                                ...
                                <div className="relative">
                                    <h3 className="text-lg font-medium text-slate-700 mb-2">CGI Concept</h3>
                                    <textarea
                                        value={topic}
                                        onChange={(e) => setTopic(e.target.value)}
                                        placeholder="e.g., a new soda that creates a portal to another dimension"
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    title="Generate a CGI ad script from your topic"
                        ...
                        <div>
                            {loading ? (
                                <ProcessingView
                                    title="Rendering CGI Concepts..."
                                    messages={[ "Building virtual worlds...", "Scripting breathtaking visuals...", "Adding cinematic flair...", "Finalizing the script..." ]}
...
export default CGIAdsGenerator;